      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-6">
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <span className="text-xl font-gt-walsheim text-foreground group-hover:opacity-80 transition-opacity">
              Space Travel Control Centre
            </span>
          </Link>

          {showGroupDropdown && (
            <div className="flex items-center gap-3 cursor-pointer hover:opacity-80 transition-opacity">
              <span className="text-xl font-bold font-gt-walsheim text-foreground">{currentGroup}</span>
